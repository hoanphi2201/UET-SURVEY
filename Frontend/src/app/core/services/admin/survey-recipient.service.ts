...
export class SurveyRecipientService {
  ...
  getSurveyRecipientList(page: number, pageSize: number, sortField: string, sortType: string, searchKey: string, searchValue: string, filterKey: string, filterValue: string) {
  ...
  updateSurveyRecipient(surveyRecipient: any, surveyRecipientId: string): Observable<any> {
    return this.apiService.put(`/survey-recipients/${surveyRecipientId}`, surveyRecipient);
  }
  ...
  deleteMultySurveyRecipient(surveyRecipientIds: any): Observable<any> {
    return this.apiService.deleteMulty('/survey-recipients/delete-multy', surveyRecipientIds);
  }
}
