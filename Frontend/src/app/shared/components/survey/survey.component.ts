...
export class SurveyComponent implements OnInit {
  ...
  saveSurveyPdf() {
    ...
    surveyPDF.onRenderFooter.add(function(_, canvas) {
      const horizontalAlign: any = 'right';
      canvas.drawText({
